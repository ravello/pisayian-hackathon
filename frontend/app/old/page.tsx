      ...
      <main className="flex flex-col gap-[32px] row-start-2 text-center items-center sm:items-center">
        ...
        <div className="border border-black/[0.1] dashed rounded-md w-6/4 h-35 items-center justify-center flex">
          <p className="m-4">
            ...
            <button
              className="ml-3 px-4 py-1 transition-colors border border-solid border-black/[0.2]  text-black rounded-full hover:bg-[#f2f2f2] hover:border-black/[0.0]"
              onClick={handleClick}
            >
              Pick a file
            </button>
        ...
        <button
          className="flex ml-3 px-4 py-1 transition-colors border border-solid border-black/[0.2]  text-black rounded-full hover:bg-[#f2f2f2] hover:border-black/[0.0]"
